...
INSERT INTO SanPham VALUES (null,'SP2',N'Son dưỡng','90.000','150.000',N'Việt Nam',N'2 tuần',GETDATE(),N'Son dưỡng thường chứa các thành phần dưỡng ẩm như dầu hạt jojoba, dầu hạt dừa, sáp ong, hoặc bơ hạt mỡ. Ngoài ra, chúng cũng có thể bổ sung vitamin E và các chất chống oxy hóa khác để bảo vệ môi khỏi tác động của tia UV và môi trường', N'Mỹ phẩm', '60%','NB01','TPHCM')
INSERT INTO SanPham VALUES (null, 'SP3',N'Máy tính','20.000.000','10.000.000',N'Thái Lan', N'5 tháng',GETDATE(),N'Bề mặt của máy thường làm từ nhựa, kim loại hoặc hợp kim nhôm, tạo cảm giác chắc chắn và sang trọng. Trên mặt trước của máy, bạn thường sẽ thấy các cổng kết nối như cổng USB, cổng âm thanh, và có thể một ổ đĩa quang để đọc đĩa CD/DVD. Màn hình hiển thị thông tin và các phím bấm để tương tác cũng là một phần quan trọng của máy tính.',N'Học tập','90%','NB02','TPHCM')
Select * from SanPham
GO
DROP TABLE SanPham
...
(
    ...
    Hinh varbinary(max),
	PRIMARY KEY(TenTaiKhoan,MaNguoiBan)
);
